...
#### 6. Initialize the Bot
        ...
        botOptions.botInfo = {"name":"Bot Name", "_id" :"Bot Id"};  //Capture Bot Name & Bot ID from Builder Tool app. Go to respective Bot and then navigate to Settings-->Genernal Settings section. Bot Name is case sensitive.
        ...
        //To modify the rtm api use the following option				
            botOptions.reWriteGetRtmRequest={
                url:'URL_TO_BE_REWRITTEN',
                headers:{myownheader:"HEADERS_TO_ADD"},
            };
				
        // To modify the jwt api use the following option
            botOptions.reWriteJwtGrantRequest={
                url:'URL_TO_BE_REWRITTEN',
                headers:{myownheader:"HEADERS_TO_ADD"}
            };
...
v6.4[Minor] on 28-March-2019:Master branch
    Released major release with following bug fixes
    1. Added new templates multi_select and like_dislike Templates
    2. we can modify the web socket url.
    3. we can modify the rtm and jwt API.
    4. Minor bug fixes.
